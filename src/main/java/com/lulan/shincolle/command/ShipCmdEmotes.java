...
public class ShipCmdEmotes extends CommandBase {
    ...
    public static final Map<Integer, Integer> EmoNameToID = new HashMap<Integer, Integer>() {{
        ...
        put("lv".hashCode(), 1);
        put("love".hashCode(), 1);
        put("heart".hashCode(), 1);
        put("2".hashCode(), 2);
        put("swt2".hashCode(), 2);
        put("wah".hashCode(), 2);
        put("panic".hashCode(), 2);
        put("3".hashCode(), 3);
        put("?".hashCode(), 3);
        put("4".hashCode(), 4);
        put("!".hashCode(), 4);
        ...
        put("6".hashCode(), 6);
        put("an".hashCode(), 6);
        put("anger".hashCode(), 6);
        put("angry".hashCode(), 6);
        put("7".hashCode(), 7);
        put("note".hashCode(), 7);
        put("ho".hashCode(), 7);
        put("8".hashCode(), 8);
        ...
        put("spit".hashCode(), 9);
        put("rice".hashCode(), 9);
        put("hungry".hashCode(), 9);
        put("10".hashCode(), 10);
        put("spin".hashCode(), 10);
        put("dizzy".hashCode(), 10);
        put("11".hashCode(), 11);
        put("find".hashCode(), 11);
        put("??".hashCode(), 11);
        put("12".hashCode(), 12);
        put("omg".hashCode(), 12);
        put("shock".hashCode(), 12);
        put("13".hashCode(), 13);
        put("ok".hashCode(), 13);
        put("nod".hashCode(), 13);
        put("14".hashCode(), 14);
        put("fsh".hashCode(), 14);
        put("flash".hashCode(), 14);
        put("+_+".hashCode(), 14);
        put("15".hashCode(), 15);
        put("kiss".hashCode(), 15);
        put("kis".hashCode(), 15);
        put("16".hashCode(), 16);
        put("lol".hashCode(), 16);
        put("ha".hashCode(), 16);
        ...
        put("17".hashCode(), 17);
        put("gg".hashCode(), 17);
        put("giggle".hashCode(), 17);
        put("18".hashCode(), 18);
        put("sigh".hashCode(), 18);
        put("19".hashCode(), 19);
        put("meh".hashCode(), 19);
        put("lick".hashCode(), 19);
        put("20".hashCode(), 20);
        put("orz".hashCode(), 20);
        put("otl".hashCode(), 20);
        put("21".hashCode(), 21);
        ...
        put("23".hashCode(), 23);
        put("!?".hashCode(), 23);
        put("surprised".hashCode(), 23);
        put("24".hashCode(), 24);
        put("rock".hashCode(), 24);
        put("bawi".hashCode(), 24);
        put("25".hashCode(), 25);
        put("paper".hashCode(), 25);
        put("bo".hashCode(), 25);
        put("26".hashCode(), 26);
        put("scissors".hashCode(), 26);
        put("gawi".hashCode(), 26);
        put("ya".hashCode(), 26);
        put("yeah".hashCode(), 26);
        put("27".hashCode(), 27);
        put("-w-".hashCode(), 27);
        put("28".hashCode(), 28);
        put("-o-".hashCode(), 28);
        put("29".hashCode(), 29);
        put("blink".hashCode(), 29);
        put("wink".hashCode(), 29);
        put("30".hashCode(), 30);
        put("pif".hashCode(), 30);
        put("31".hashCode(), 31);
        put("shine".hashCode(), 31);
        put("shy".hashCode(), 31);
        put("32".hashCode(), 32);
        put("hmm".hashCode(), 32);
        put("33".hashCode(), 33);
