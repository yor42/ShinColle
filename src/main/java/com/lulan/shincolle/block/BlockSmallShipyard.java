    ...
    public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random rand) {
        ...
        if (state.getValue(ACTIVE)) {
            ...
            switch (rand.nextInt(3)) {
                case 0:
                    //主煙囪特效
                    world.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, x + smokeR1[0], y + smokeR1[1], z + smokeR1[2], 0.0D, 0D, 0.0D);
                    world.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, x + smokeR1[0], y + smokeR1[1] + 0.1D, z + smokeR1[2], 0.0D, 0.005D, 0.0D);
                    world.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, x + smokeR1[0], y + smokeR1[1] + 0.2D, z + smokeR1[2], 0.0D, 0.01D, 0.0D);
                    //小煙囪特效
                    world.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, x + smokeR3[0], y + smokeR3[1], z + smokeR3[2], 0.0D, 0D, 0.0D);
                    world.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, x + smokeR3[0], y + smokeR3[1] + 0.1D, z + smokeR3[2], 0.0D, 0.01D, 0.0D);
                    break;
                case 1:
                    //主煙囪特效
                    world.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, x + smokeR1[0], y + smokeR1[1], z + smokeR1[2], 0.0D, 0D, 0.0D);
                    ...
                    world.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, x + smokeR1[0], y + smokeR1[1] + 0.2D, z + smokeR1[2], 0.0D, 0.01D, 0.0D);
                    //中煙囪特效
                    world.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, x + smokeR2[0], y + smokeR2[1], z + smokeR2[2], 0.0D, 0D, 0.0D);
                    world.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, x + smokeR2[0], y + smokeR2[1] + 0.1D, z + smokeR2[2], 0.0D, 0.01D, 0.0D);
                    break;
                case 2:
                    //中煙囪特效
                    world.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, x + smokeR2[0], y + smokeR2[1], z + smokeR2[2], 0.0D, 0D, 0.0D);
