...
public class GuiMorphInventory extends GuiContainer {
    ...
    private static String strAttrATK;
    private static String strAttrAIR;
    ...
    private static String strNofuel;
    private static String strAttrModern;
    private static String strAttrXP;
    private static String strAttrGrudge;
    private static String strAttrAmmo;
    private static String strAttrHPRES;
    private static String strShowHeld;
    private static String strAttrKB;
    private static String strAttrHP;
    private static String strAppear;
    private static String strSit;
    private static String strEmoFlag1;
    private static String strEmoFlag2;
    ...
    public GuiMorphInventory(CapaTeitoku capa, InventoryPlayer invPlayer, BasicEntityShip entity) {
        ...
        boolean[] switchPage3 = new boolean[6];    //page 3 button value
        boolean[] switchPage4 = new boolean[6];    //page 4 button value
        ...
        //AI string
        String canMelee = I18n.format("gui.shincolle:canmelee");
        String canLATK = I18n.format("gui.shincolle:canlightattack");
        String canHATK = I18n.format("gui.shincolle:canheavyattack");
        String canALATK = I18n.format("gui.shincolle:canairlightattack");
        String canAHATK = I18n.format("gui.shincolle:canairheavyattack");
        auraEffect = I18n.format("gui.shincolle:auraeffect");
        String strTimeKeep = I18n.format("gui.shincolle:ai.timekeeper");
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        switch (this.showPageAI) {
            case 1: {    //page 1
                ...
                this.switchPage1a[2] = this.entity.getStateEmotion(ID.S.Emotion) > 0;
                this.switchPage1a[3] = this.entity.getStateEmotion(ID.S.Emotion4) > 0;
        ...
        //Attrs tooltip
            ...
            if (showPage == 2) {
                ...
                if (yMouse >= 18 + guiTop && yMouse < 41 + guiTop) {
                    ...
                    String overText = (int) (attrs.getAttrsBuffed(ID.Attrs.CRI) * 100F) + " %";
    ...
    protected void mouseClicked(int posX, int posY, int mouseKey) throws IOException {
        ...
        switch (GuiHelper.getButton(0, 0, xClick, yClick)) {
            ...
            case 4:    //AI operation 1
                if (this.showPageAI == 1) {        //page 1: state: sit
                    this.switchPage1a[1] = this.entity.isSitting();
            ...
            case 7:    //AI operation 4
                if (this.showPageAI == 6) {        //page 6: model display switch button 8~11
                    if (xClick < btCols[0]) {
        ...
        if (this.showPage == 2) {    //page 2: damage display switch
            if (GuiHelper.getButton(ID.Gui.SHIPINVENTORY, 1, xClick, yClick) == 0) {
