...
public class ContainerLargeShipyard extends Container {
    ...
    public void detectAndSendChanges() {
        ...
        for (int i = 0; i < this.listeners.size(); ++i) {
            ...
            if (this.guiMatBuild[0] != this.tile.getMatBuild(0)) {    //更新MatBuild材料量0
                tileListener.sendWindowProperty(this, 3, this.tile.getMatBuild(0));
            }

            if (this.guiMatBuild[1] != this.tile.getMatBuild(1)) {    //更新MatBuild材料量1
                tileListener.sendWindowProperty(this, 4, this.tile.getMatBuild(1));
            }

            if (this.guiMatBuild[2] != this.tile.getMatBuild(2)) {    //更新MatBuild材料量2
                tileListener.sendWindowProperty(this, 5, this.tile.getMatBuild(2));
            }

            if (this.guiMatBuild[3] != this.tile.getMatBuild(3)) {    //更新MatBuild材料量3
