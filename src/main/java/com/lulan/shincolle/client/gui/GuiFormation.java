...
public class GuiFormation extends GuiContainer {
    ...
    private static String attrGRUDGE;
    private static String attrHPRES;
    private static String attrKB;
    ...
    //animation
    private final int[][] spotPos;        //formation position spot current [x, y][pos]
    private final int[][] spotPosFinal;    //formation position spot final [x, y][pos]
    private final float[] buffBar;        //formation buff bar length [length]
    private final float[] buffBarFinal;    //formation buff bar final length [length]
    //player data
    EntityPlayer player;
    CapaTeitoku capa;
    ...
    public GuiFormation(EntityPlayer par1) {
        ...
        //string
        String attrHP = TextFormatting.YELLOW + I18n.format("gui.shincolle:hp");
        ...
        String attrXP = TextFormatting.GREEN + I18n.format("gui.shincolle:equip.xp");
        attrGRUDGE = TextFormatting.DARK_PURPLE + I18n.format("gui.shincolle:equip.grudge");
        String attrAMMO = TextFormatting.DARK_AQUA + I18n.format("gui.shincolle:equip.ammo");
        ...
        String strErr01 = I18n.format("gui.shincolle:formation.notenough");
    ...
    private String getAttributeString(byte attrid) {
        ...
        switch (attrid) {
            ...
            case ID.Attrs.MOV:
                ...
                if (mov > (float) ConfigHandler.limitShipAttrs[ID.Attrs.MOV])
                    mov = (float) ConfigHandler.limitShipAttrs[ID.Attrs.MOV];
    ...
    private void setShipName() {
        ...
        if (shipList != null) {
            for (int i = 0; i < 6; i++) {
                if (shipList[i] != null) {
                    //get name
                    shipList[i].getCustomNameTag();
                    if (!shipList[i].getCustomNameTag().isEmpty()) {
