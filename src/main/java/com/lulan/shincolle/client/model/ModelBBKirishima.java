...
/**
 * ModelBBKirishima - PinkaLulan 2018/2/10
 * Created using Tabula 6.0.0
 */
public class ModelBBKirishima extends ShipModelBaseAdv {
    ...
    public ModelRenderer EquipGlass01;
    ...
    public ModelRenderer EquipGlass02a;
    public ModelRenderer EquipGlass02b;
    ...
    public ModelBBKirishima() {
        ...
        this.EquipGlass02a = new ModelRenderer(this, 90, 5);
        this.EquipGlass02a.setRotationPoint(7.8F, 2.1F, -0.2F);
        this.EquipGlass02a.addBox(-0.5F, 0.0F, 0.0F, 1, 1, 10, 0.0F);
        ...
        this.EquipHead00 = new ModelRenderer(this, 44, 16);
        ...
        this.EquipGlass01 = new ModelRenderer(this, 90, 0);
        this.EquipGlass01.setRotationPoint(0.0F, -8.1F, -8.4F);
        this.EquipGlass01.addBox(-8.0F, 0.0F, 0.0F, 16, 5, 0, 0.0F);
        ...
        this.EquipGlass02b = new ModelRenderer(this, 90, 5);
        this.EquipGlass02b.setRotationPoint(-7.8F, 2.1F, -0.2F);
        this.EquipGlass02b.addBox(-0.5F, 0.0F, 0.0F, 1, 1, 10, 0.0F);
        ...
        this.Hair01 = new ModelRenderer(this, 50, 39);
        this.Hair01.setRotationPoint(0.0F, 7.7F, 1.2F);
        this.Hair01.addBox(-8.0F, 0.0F, 0.0F, 16, 8, 9, 0.0F);
        this.setRotateAngle(Hair01, 0.10471975511965977F, 0.0F, 0.0F);
        ...
        this.Ahoke = new ModelRenderer(this, 118, 42);
        this.Ahoke.setRotationPoint(-0.3F, -5.1F, -7.5F);
        this.Ahoke.addBox(-1.5F, 0.0F, 0.0F, 5, 7, 0, 0.0F);
        this.setRotateAngle(Ahoke, -0.13962634015954636F, -0.17453292519943295F, 0.08726646259971647F);
        ...
        this.EquipGlass01.addChild(this.EquipGlass02a);
        ...
        this.Head.addChild(this.EquipGlass01);
        ...
        this.EquipGlass01.addChild(this.EquipGlass02b);
    ...
    public void showEquip(IShipEmotion ent) {
        ...
        this.EquipGlass01.isHidden = flag;
    }
    ...
    public void applyDeadPose(float f, float f1, float f2, float f3, float f4, IShipEmotion ent) {
        ...
        //hair
        this.Ahoke.rotateAngleZ = 0.087F;
        //arm
    ...
    public void applyNormalPose(float f, float f1, float f2, float f3, float f4, IShipEmotion ent) {
        ...
        this.Ahoke.rotateAngleZ = angleX * 0.08F + 0.05F;
        //boob
        ...
        if (ent.getAttackTick() > 20) {
            ...
            this.ArmLeft02.rotateAngleZ = 1.3F;
