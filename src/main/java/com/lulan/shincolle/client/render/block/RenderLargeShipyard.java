...
public class RenderLargeShipyard extends TileEntitySpecialRenderer<BasicTileEntity> {
    ...
    //貼圖檔路徑
    private static final ResourceLocation TEXTURE_BASE = new ResourceLocation(Tags.TEXTURES_BLOCKS + "BlockLargeShipyard.png");
    private static final ResourceLocation VORTEX_OFF = new ResourceLocation(Tags.TEXTURES_BLOCKS + "ModelVortex.png");
    private static final ResourceLocation VORTEX_ON = new ResourceLocation(Tags.TEXTURES_BLOCKS + "ModelVortexOn.png");
