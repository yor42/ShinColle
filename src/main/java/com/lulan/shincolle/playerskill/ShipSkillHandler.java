...
public class ShipSkillHandler {
    ...
    protected static void handleSkillKeysMounts() {
        ...
        if (ClientProxy.keyMountActionCD <= 0) {
            ...
            //jump
            if (keySet.keyBindJump.isKeyDown() && (mount.onGround || EntityHelper.checkEntityIsInLiquid(mount)))
                newKeys = newKeys | 16;
...
//				}
    ...
    public static void handleSkillKeysMorph() {
        ...
        if (capa != null && capa.morphEntity instanceof BasicEntityShip && ClientProxy.showMorphSkills)
