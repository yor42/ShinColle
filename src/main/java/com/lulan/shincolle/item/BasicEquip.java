        ...
        if (!stack.isEmpty() && stack.getItem() != null) {
            ...
            if (main != null && misc != null) {
                ...
                if (main[ID.Attrs.HP] != 0F)
                    list.add(TextFormatting.RED + String.format("%.1f", main[ID.Attrs.HP] * (float) ConfigHandler.scaleShip[ID.AttrsBase.HP]) + " " + I18n.format("gui.shincolle:hp"));
                if (main[ID.Attrs.ATK_L] != 0F)
                    list.add(TextFormatting.RED + String.format("%.1f", main[ID.Attrs.ATK_L] * (float) ConfigHandler.scaleShip[ID.AttrsBase.ATK]) + " " + I18n.format("gui.shincolle:firepower1"));
                if (main[ID.Attrs.ATK_H] != 0F)
                    list.add(TextFormatting.GREEN + String.format("%.1f", main[ID.Attrs.ATK_H] * (float) ConfigHandler.scaleShip[ID.AttrsBase.ATK]) + " " + I18n.format("gui.shincolle:torpedo"));
                if (main[ID.Attrs.ATK_AL] != 0F)
                    list.add(TextFormatting.RED + String.format("%.1f", main[ID.Attrs.ATK_AL] * (float) ConfigHandler.scaleShip[ID.AttrsBase.ATK]) + " " + I18n.format("gui.shincolle:airfirepower"));
                if (main[ID.Attrs.ATK_AH] != 0F)
                    list.add(TextFormatting.GREEN + String.format("%.1f", main[ID.Attrs.ATK_AH] * (float) ConfigHandler.scaleShip[ID.AttrsBase.ATK]) + " " + I18n.format("gui.shincolle:airtorpedo"));
                if (main[ID.Attrs.DEF] != 0F)
                    list.add(TextFormatting.WHITE + String.format("%.1f", main[ID.Attrs.DEF] * 100F * (float) ConfigHandler.scaleShip[ID.AttrsBase.DEF]) + "% " + I18n.format("gui.shincolle:armor"));
                if (main[ID.Attrs.SPD] != 0F)
                    list.add(TextFormatting.WHITE + String.format("%.2f", main[ID.Attrs.SPD] * (float) ConfigHandler.scaleShip[ID.AttrsBase.SPD]) + " " + I18n.format("gui.shincolle:attackspeed"));
                if (main[ID.Attrs.MOV] != 0F)
                    list.add(TextFormatting.GRAY + String.format("%.2f", main[ID.Attrs.MOV] * (float) ConfigHandler.scaleShip[ID.AttrsBase.MOV]) + " " + I18n.format("gui.shincolle:movespeed"));
                if (main[ID.Attrs.HIT] != 0F)
                    list.add(TextFormatting.LIGHT_PURPLE + String.format("%.1f", main[ID.Attrs.HIT] * (float) ConfigHandler.scaleShip[ID.AttrsBase.HIT]) + " " + I18n.format("gui.shincolle:range"));
                if (main[ID.Attrs.CRI] != 0F)
                    list.add(TextFormatting.AQUA + String.format("%.0f", main[ID.Attrs.CRI] * 100F) + "% " + I18n.format("gui.shincolle:critical"));
                if (main[ID.Attrs.DHIT] != 0F)
                    list.add(TextFormatting.YELLOW + String.format("%.0f", main[ID.Attrs.DHIT] * 100F) + "% " + I18n.format("gui.shincolle:doublehit"));
                if (main[ID.Attrs.THIT] != 0F)
                    list.add(TextFormatting.GOLD + String.format("%.0f", main[ID.Attrs.THIT] * 100F) + "% " + I18n.format("gui.shincolle:triplehit"));
                if (main[ID.Attrs.MISS] != 0F)
                    list.add(TextFormatting.RED + String.format("%.0f", main[ID.Attrs.MISS] * 100F) + "% " + I18n.format("gui.shincolle:missreduce"));
                if (main[ID.Attrs.DODGE] != 0F)
                    list.add(TextFormatting.GOLD + String.format("%.0f", main[ID.Attrs.DODGE] * 100F) + "% " + I18n.format("gui.shincolle:dodge"));
                if (main[ID.Attrs.AA] != 0F)
                    list.add(TextFormatting.YELLOW + String.format("%.1f", main[ID.Attrs.AA]) + " " + I18n.format("gui.shincolle:antiair"));
                if (main[ID.Attrs.ASM] != 0F)
                    list.add(TextFormatting.AQUA + String.format("%.1f", main[ID.Attrs.ASM]) + " " + I18n.format("gui.shincolle:antiss"));
                if (main[ID.Attrs.XP] != 0F)
                    list.add(TextFormatting.GREEN + I18n.format("gui.shincolle:equip.xp") + " " + String.format("%.0f", main[ID.Attrs.XP] * 100F) + "%");
                if (main[ID.Attrs.GRUDGE] != 0F)
                    list.add(TextFormatting.DARK_PURPLE + I18n.format("gui.shincolle:equip.grudge") + " " + String.format("%.0f", main[ID.Attrs.GRUDGE] * 100F) + "%");
                if (main[ID.Attrs.AMMO] != 0F)
                    list.add(TextFormatting.DARK_AQUA + I18n.format("gui.shincolle:equip.ammo") + " " + String.format("%.0f", main[ID.Attrs.AMMO] * 100F) + "%");
                if (main[ID.Attrs.HPRES] != 0F)
                    list.add(TextFormatting.DARK_GREEN + I18n.format("gui.shincolle:equip.hpres") + " " + String.format("%.0f", main[ID.Attrs.HPRES] * 100F) + "%");
                if (main[ID.Attrs.KB] != 0F)
                    list.add(TextFormatting.DARK_RED + I18n.format("gui.shincolle:equip.kb") + " " + String.format("%.0f", main[ID.Attrs.KB] * 100F) + "%");
