...
public class ConfigSound extends BasicShipConfig {
    ...
    /**
     * custom sound rate: map (shipID, sound rate array)
     * <p>
     * sound rate array:
     * 0:idle, 1:hit, 2:hurt, 3:dead, 4:marry, 5:knockback, 6:item, 7:feed, 8:timekeep
     */
    ...
    public ConfigSound(File file) throws Exception {
        ...
        SOUNDRATE = new HashMap<Integer, float[]>();
    }
