        ...
        if (this.world.isRemote) {
            ...
            if (this.deathTime >= 89) {
                ...
                for (int i = 0; i < 12; ++i) {
                    ...
                    this.world.spawnParticle(EnumParticleTypes.LAVA, this.posX + ran1, this.posY + this.height * 0.3D, this.posZ + ran2, 0D, 0D, 0D);

                    if ((i & 3) == 0) {
                        this.world.spawnParticle(EnumParticleTypes.EXPLOSION_LARGE, this.posX + ran2, this.posY + this.height * 0.5D, this.posZ + ran1, 0D, 0D, 0D);
                    }
                }
            }
        }
