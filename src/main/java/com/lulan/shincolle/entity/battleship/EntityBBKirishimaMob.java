...
public class EntityBBKirishimaMob extends BasicEntityShipHostile {
    ...
    private final float smokeX2;
    private final float smokeY2;
    ...
    public EntityBBKirishimaMob(World world) {
        ...
        //model display
        this.setStateEmotion(ID.S.State, 5 + (this.rand.nextInt(2) == 0 ? 0 : 2), false);
    }
    ...
    public void initAttrsServerPost() {
        ...
        this.AttackEffectMap.put(15, new int[]{(int) (this.getScaleLevel() / 1.5), 40 + this.getScaleLevel() * 30, 25 + this.getScaleLevel() * 25});
    }
