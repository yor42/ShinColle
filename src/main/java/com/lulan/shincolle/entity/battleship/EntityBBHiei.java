...
public class EntityBBHiei extends BasicEntityShipSmall {
    ...
    public EntityBBHiei(World world) {
        super(world);
                    ...
                    if (shiplist != null && shiplist.size() > 0) {
                        for (BasicEntityShip s : shiplist) {
                            if (TeamHelper.checkSameOwner(this, s)) {
                                ...
                                s.addPotionEffect(new PotionEffect(MobEffects.SATURATION, 100 + getStateMinor(ID.M.ShipLevel) * 2, getStateMinor(ID.M.ShipLevel) / 120, false, false));
                            }
                        }
                    }
                }//end married buff
    ...
    public void calcShipAttributesAddEffect() {
        ...
        this.AttackEffectMap.put(19, new int[]{this.getLevel() / 85, 80 + this.getLevel(), this.getLevel()});
    }
