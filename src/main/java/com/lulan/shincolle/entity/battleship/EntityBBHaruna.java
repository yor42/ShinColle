...
public class EntityBBHaruna extends BasicEntityShipSmall {
                    ...
                    if (shiplist != null && shiplist.size() > 0) {
                        for (BasicEntityShip s : shiplist) {
                            if (TeamHelper.checkSameOwner(this, s)) {
                                ...
                                s.addPotionEffect(new PotionEffect(MobEffects.LUCK, 100 + getStateMinor(ID.M.ShipLevel), getStateMinor(ID.M.ShipLevel) / 120, false, false));
                            }
                        }
                    }
                }//end married buff
    ...
    public void calcShipAttributesAddEffect() {
        ...
        this.AttackEffectMap.put(27, new int[]{this.getLevel() / 95, 100 + this.getLevel(), this.getLevel()});
    }
