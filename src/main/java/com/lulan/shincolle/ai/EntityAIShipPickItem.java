...
public class EntityAIShipPickItem extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        if (this.hostShip != null) {
            ...
            return this.hostShip.getCapaShipInventory().getFirstSlotForItem() > 0;
        }
        //mount類
        else if (this.hostMount != null && this.hostShip != null) {
            //check fishing
            if (hostMount.getHostEntity() != null &&
                    ((BasicEntityShip) hostMount.getHostEntity()).fishHook != null) return false;
                ...
                if ((this.hostMount != null && this.hostMount.getDistanceSq(this.entItem) < 9D) ||
                    ...
                    if (!entItem.cannotPickup() &&
                        ...
                        if (this.hostShip.getStateTimer(ID.T.SoundTime) <= 0 && this.hostShip.getRNG().nextInt(2) == 0) {
                            ...
                            this.hostShip.playSound(BasicEntityShip.getCustomSound(6, this.hostShip), ConfigHandler.volumeShip, 1F);
                        }
