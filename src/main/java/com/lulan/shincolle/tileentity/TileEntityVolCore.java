...
public class TileEntityVolCore extends BasicTileInventory implements ITickable {
    ...
    public boolean isItemValidForSlot(int slot, ItemStack stack) {
        if (!stack.isEmpty()) {
            ...
            return item == ModItems.Grudge || item == Item.getItemFromBlock(ModBlocks.BlockGrudge);
        }
    ...
    public boolean decrItemFuel() {
        ...
        for (int i = 0; i < this.itemHandler.getSlots(); i++) {
            ...
            if (!stack.isEmpty()) {
                ...
                if (fuelx > 0 && fuelx + this.remainedPower < POWERMAX) {
    ...
    public void update() {
        ...
        if (!world.isRemote) {
            ...
            if (this.syncTime % 16 == 0) {
                ...
                //fuel--
                if (this.isWorking()) this.remainedPower -= CONSUMEDSPEED;
